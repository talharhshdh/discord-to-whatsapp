...
var movie_downloader_1 = require("../libs/movie-downloader");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var tmdbId, mediaType, urls;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    tmdbId = 1007757;
                    mediaType = ((_a = process.argv[3]) !== null && _a !== void 0 ? _a : 'movie');
                    return [4 /*yield*/, (0, movie_downloader_1.getMovieStreamUrls)(tmdbId, "movie")];
                case 1:
                    urls = _b.sent();
                    if (urls.length === 0) {
